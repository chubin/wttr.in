...
func NewPipeline(opts *config.Options, weatherer Weatherer, ipDataer IPDataer) *Pipeline {
...
func parseQueryOptions(r *http.Request) (*config.Options, error) {
	// Stub: To be implemented
	return nil, nil
}
